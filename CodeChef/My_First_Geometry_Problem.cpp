...
int main()
{
    ...
    {
        string s;cin>>s;
        if(s == "1000" or s == "0100" or s == "0010" or s == "0001") cout << 11 << endl;
        else if (s == "1100" or s == "0011") cout << 21 << endl;
        else if (s == "1010" or s == "1001" or s == "0110" or s == "0101") cout << 121 << endl;
        else if (s == "1111") cout << 441 << endl;
        else if (s == "1110" or s == "1101" or s == "1011" or s == "0111") cout << 231 << endl;
        else if (s == "0000") cout << 1 << endl;
    }
    return 0;
}